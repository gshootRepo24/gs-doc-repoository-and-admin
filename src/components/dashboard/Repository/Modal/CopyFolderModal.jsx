...
import {
  ...
  Star as StarIcon, MoreHoriz as MoreHorizIcon, ContentCopy as ContentCopyIcon, NavigateBefore as NavigateBeforeIcon, NavigateNext as NavigateNextIcon
...
const CopyFolderModal = ({ modalOpen, handleModalClose, parentFolder, folderIndex }) => {
  ...
  const handleCopyHere = async () => {
    try {
      await copyFolder(folderIndex, lookInsideId, parentFolder);
      handleModalClose();
    } catch (error) {
